...
import locale from 'vue2-ld-datatable/locale/zh-cn'

Vue.use(Datatable, { locale }) // done!
```

What's in the `locale`? Let's take a look at [`locale/zh-cn.js`](https://github.com/LaravelDaily/vue2-ld-datatable/blob/master/locale/zh-cn.js):
...
Copy and paste from [`src/main.js`](https://github.com/LaravelDaily/vue2-ld-datatable/blob/master/src/main.js):
...
Apply to [`src/PageSizeSelect.vue`](https://github.com/LaravelDaily/vue2-ld-datatable/blob/master/src/PageSizeSelect.vue):
